...
# Change this if your default location is not Nepal/Kathmandu.
DEFAULT_ORIGIN_IATA = os.getenv("DEFAULT_ORIGIN_IATA", "KTM")
...
#     print(search_flights("Plan a 7 days trip to Japan from Nepal"))
#     print("\n" + "=" * 80 + "\n")
